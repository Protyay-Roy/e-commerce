            ...
            <div class="col-md-12">
                ...
                <div id="productMain" class="row">
                            ...
                            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <center><img class="img-responsive" src="admin_area/product_images/<?=$pro_img1?>" alt="Product 3-a"></center>
                                    </div>
                                    <div class="item">
                                        <center><img class="img-responsive" src="admin_area/product_images/<?=$pro_img2?>" alt="Product 3-b"></center>
                                    </div>
                                    <div class="item">
                                        <center><img class="img-responsive" src="admin_area/product_images/<?=$pro_img3?>" alt="Product 3-c"></center>
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="box">
                            ...
                            <form action="details.php?addCart=<?=$pro_id?>" class="form-horizontal" method="post">
                        ...
                        <div class="row" id="thumbs">
                            ...
                            <div class="col-xs-4">
                                ...
                                <a href="#" class="thumb" data-target="#myCarousel" data-slide-to="1">
                                    <!-- thumb Begin -->
                                    <img src="admin_area/product_images/<?=$pro_img2?>" alt="<?=$pro_img2?>" class="img-responsive">
                                </a><!-- thumb Finish -->
                            </div><!-- col-xs-4 Finish -->
                            ...
                            <div class="col-xs-4">
                                ...
                                <a href="#" class="thumb" data-target="#myCarousel" data-slide-to="2">
                                    <!-- thumb Begin -->
                                    <img src="admin_area/product_images/<?=$pro_img3?>" alt="<?=$pro_img3?>" class="img-responsive">
                                </a><!-- thumb Finish -->
                            </div><!-- col-xs-4 Finish -->
                ...
                <div id="row same-heigh-row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="box same-height headline" style="height: 359px;">
